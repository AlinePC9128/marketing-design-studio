...
Las exploraciones de `assets/identity-2026/` son conceptos de marca minimalistas para mostrar cómo trabajo un logo: símbolo, retícula, versiones monocromáticas, escalabilidad y aplicaciones. La lámina `marcas-mexicanas-minimalistas.svg` reúne seis ejercicios ficticios de ilustración lineal, nombre y descriptor; no representa una categoría comercial ni trabajos de clientes. La carpeta `assets/rebranding-autosise/` separa los logotipos públicos de AUTOSISE de una propuesta conceptual de evolución visual creada para el portafolio.
